(() => {
  ...
  const TEXT={
    pt:{posts:'posts',followers:'seguidores',following:'seguindo',edit:'Editar perfil',changePhoto:'Trocar foto',bioLabel:'Bio',save:'Salvar alterações',cancel:'Cancelar',full:'Ver perfil completo',loading:'Carregando mais Mariana...',failed:'Não foi possível carregar o perfil completo.',failedCopy:'Ainda existem fotos que a gente não tirou, lugares que não visitou e versões de nós que esse perfil ainda não conhece. Esse espaço ficou reservado para elas.',back:'Voltar para o perfil',credits:'Créditos',creditTitle:'Créditos finais',creditIntro:'Um site feito para guardar uma história que, felizmente, ainda está longe de terminar.',creditMessage:'Esse espaço é para agradecer a todas as partes que fizeram este cantinho existir. À Mariana, por ser a inspiração de cada detalhe, de cada música e de cada memória que ganhou lugar aqui. Ao Raphael, pelas ideias, pelos textos, pelas escolhas e por transformar sentimentos em páginas. E também às ferramentas que ajudaram a tirar tantas ideias da cabeça e colocar tudo para funcionar. No fim, esses créditos não são sobre quem fez uma parte específica, são sobre tudo o que se juntou para contar um pouco da nossa história, e sobre tudo o que ainda vamos acrescentar juntos.',roles:[['Protagonista','Mariana'],['Criado para','Mariana, com todo o carinho'],['Ideia, textos e direção','Raphael'],['História original','nós dois'],['Assistência criativa e técnica','ChatGPT']],ending:'Se você chegou até aqui, então valeu cada detalhe. Isto não é o resumo da nossa história, é só mais uma página dela.',pixel:'continua...',tabs:['Fotos','Reels','Reposts','Mencionados']},
    en:{posts:'posts',followers:'followers',following:'following',edit:'Edit profile',changePhoto:'Change photo',bioLabel:'Bio',save:'Save changes',cancel:'Cancel',full:'View full profile',loading:'Loading more Mariana...',failed:'The full profile could not be loaded.',failedCopy:'There are still photos we have not taken, places we have not visited and versions of us this profile has not met yet. This space is reserved for them.',back:'Back to profile',credits:'Credits',creditTitle:'Final credits',creditIntro:'A website made to keep a story that, thankfully, is still far from ending.',creditMessage:'This space is here to thank every part that helped this little corner exist. Mariana, for inspiring every detail, every song and every memory that found a place here. Raphael, for the ideas, the writing, the choices and for turning feelings into pages. And the tools that helped move so many ideas from imagination into something that actually works. In the end, these credits are not about who made one specific piece, they are about everything that came together to tell a little of our story, and everything we still get to add together.',roles:[['Starring','Mariana'],['Created for','Mariana, with all my affection'],['Idea, writing and direction','Raphael'],['Original story','us two'],['Creative and technical help','ChatGPT']],ending:'If you made it this far, every tiny detail was worth it. This is not the summary of our story, just another page of it.',pixel:'to be continued...',tabs:['Photos','Reels','Reposts','Tagged']},
    es:{posts:'posts',followers:'seguidores',following:'siguiendo',edit:'Editar perfil',changePhoto:'Cambiar foto',bioLabel:'Bio',save:'Guardar cambios',cancel:'Cancelar',full:'Ver perfil completo',loading:'Cargando más Mariana...',failed:'No fue posible cargar el perfil completo.',failedCopy:'Todavía existen fotos que no tomamos, lugares que no visitamos y versiones de nosotros que este perfil aún no conoce. Este espacio quedó reservado para ellas.',back:'Volver al perfil',credits:'Créditos',creditTitle:'Créditos finales',creditIntro:'Un sitio hecho para guardar una historia que, por suerte, todavía está lejos de terminar.',creditMessage:'Este espacio existe para agradecer a todas las partes que hicieron posible este pequeño rincón. A Mariana, por inspirar cada detalle, cada canción y cada recuerdo que encontró un lugar aquí. A Raphael, por las ideas, los textos, las decisiones y por transformar sentimientos en páginas. Y también a las herramientas que ayudaron a convertir tantas ideas en algo que realmente funciona. Al final, estos créditos no hablan de quién hizo una parte específica, sino de todo lo que se unió para contar un poco de nuestra historia y de todo lo que todavía vamos a añadir juntos.',roles:[['Protagonista','Mariana'],['Creado para','Mariana, con todo mi cariño'],['Idea, textos y dirección','Raphael'],['Historia original','nosotros dos'],['Ayuda creativa y técnica','ChatGPT']],ending:'Si llegaste hasta aquí, entonces cada detalle valió la pena. Esto no es el resumen de nuestra historia, es solo una página más.',pixel:'continúa...',tabs:['Fotos','Reels','Reposts','Menciones']}
  };
